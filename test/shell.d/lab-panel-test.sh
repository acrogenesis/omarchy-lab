...
assert(panel.includes('viewerCommand: labCommand("omarchy-lab-viewer")') && panel.includes('Qt.resolvedUrl("bin/" + name)'), 'Lab panel resolves bundled commands independently of host PATH')
